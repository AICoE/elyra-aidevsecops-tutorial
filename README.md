...
3. Create Service using `oc apply -f ./manifests/base/service.yaml`.

4. Create Route using `oc apply -f ./manifests/base/route.yaml`.

5. Create DeploymentConfig using `oc apply -f ./manifests/base/deploymentconfig.yaml`.
